...
list_config() {
	...
	have_flag USE_SU980 && echo "CONFIG_WITH_COOLAPI=y" || echo "# CONFIG_WITH_COOLAPI=n"
	...
	do
		...
		then
			...
			enabled $OPT && have_flag USE_SU980 && echo "CONFIG_${OPT}_COOLAPI=y" || echo "# CONFIG_${OPT}_COOLAPI=n"
